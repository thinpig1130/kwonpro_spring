 ...
 * Generated at: 2020-07-29 06:52:05 UTC
...
public final class join_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<form action=\"/member/confirm\">\r\n");
      out.write("\t\t\t\t\t\t\t<fieldset>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t<main>\r\n");
      out.write("\t\t\t\t<h2 class=\"main title\">회원가입 폼</h2>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<div class=\"breadcrumb\" style=\"margin-top: -20px;\">\r\n");
      out.write("\t\t\t\t\t<h3 class=\"hidden\">경로</h3>\r\n");
      out.write("\t\t\t\t\t<img src=\"/resources/images/member/step2.png\" alt=\"회원가입 1단계\" />\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<form action=\"/member/confirm\" id=\"form1\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t<fieldset>\r\n");
      out.write("\t\t\t\t\t\t<legend class=\"hidden\">회원정보</legend>\r\n");
      out.write("\t\t\t\t\t\t<table class=\"table margin-top first\">\r\n");
      out.write("\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th><label>아이디</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td colspan=\"3\" class=\"text-align-left indent\"><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"id-text\" type=\"text\" name=\"id\" class=\"width-half\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\trequired=\"required\" value=\"\" placeholder=\"영문과 숫자 6~20자 이내\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tpattern=\"^\\w{6,20}$\" /> <input class=\"btn-text btn-default\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"button\" id=\"id-check-button\" value=\"중복확인\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th><label>비밀번호</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td colspan=\"3\" class=\"text-align-left indent\"><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"password\" name=\"pwd\" class=\"\" required\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"비밀번호 입력\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th><label>비밀번호 확인</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td colspan=\"3\" class=\"text-align-left indent\"><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"\" name=\"pwd2\" type=\"password\" required /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th><label>이름</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td colspan=\"3\" class=\"text-align-left indent\"><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"width-half\" name=\"name\" type=\"text\" value=\"\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\trequired=\"required\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- <tr>\r\n");
      out.write("                                    <th><label>필명</label></th>\r\n");
      out.write("                                    <td colspan=\"3\" class=\"text-align-left indent\"><input class=\"width-half\" name=\"nicname\" type=\"text\" /></td>\r\n");
      out.write("                                </tr> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th><label>성별</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td colspan=\"3\" class=\"text-align-left indent\"><select\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"width-half\" name=\"sex\" required>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th><label>생년월일</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td colspan=\"3\" class=\"text-align-left indent\"><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"birthday\" type=\"date\" class=\"width-half\" required\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"예) 2000-02-17\" value=\"\" /> <!-- <input name=\"y\" type=\"text\" class=\"width-small margin-hor\" style=\"margin-left:0px;\" />년\r\n");
      out.write("                                        <input name=\"m\" type=\"text\" class=\"width-small margin-hor\" />월\r\n");
      out.write("                                        <input name=\"d\" type=\"text\" class=\"width-small margin-hor\" />일 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"isLunar\" value=\"0\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"vertical-middle margin-hor\" checked />양력 <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"radio\" name=\"isLunar\" value=\"1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"vertical-middle margin-hor\" />음력</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th><label>핸드폰번호</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td colspan=\"3\" class=\"text-align-left indent\"><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"phone\" type=\"text\" class=\"width-half\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tpattern=\"^01[016789]-\\d{3,4}-\\d{4}$\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"예) 010-1111-2222\" required value=\"\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th><label>이메일</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td colspan=\"3\" class=\"text-align-left indent\"><input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"email\" type=\"email\" class=\"width-half\" required\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"예) user@newlecture.com\" value=\"\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td colspan=\"4\"><input type=\"hidden\" name=\"\" value=\"\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input id=\"submit-Button\" type=\"submit\" name=\"btn\" value=\"확인\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"height: 30px; margin: 20px;\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"btn-text btn-default\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</fieldset>\r\n");
