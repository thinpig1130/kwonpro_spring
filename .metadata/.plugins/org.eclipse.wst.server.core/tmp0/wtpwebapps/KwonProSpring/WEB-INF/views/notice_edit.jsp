			...
			<main>
                ...
                <form method="post" action="/notice/update" >
                    <div class="margin-top first">
                    	...
                    	<input type="hidden" name="file" value="${notice.files}">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr class="content">
                                    <td colspan="4"><textarea class="content" name="content">${notice.content}</textarea></td>
                                </tr>
                                <tr>
                    ...
                    <div class="margin-top text-align-center">
                        ...
                        <a class="btn-text btn-cancel" href="/notice/detail?id=${notice.id}">취소</a>
                    </div>
                </form>
